...
confidence_score = 0.5  # Confidence threshold for detections
...
video_path = "/Users/yasinyldrm/Coding/Python-PyCharm/UAV/data/inference/test-video2.mp4"
save_path = "/Users/yasinyldrm/Coding/Python-PyCharm/UAV/data/results/processed-uav-detection6.mp4"
...
while True:
    ...
    for box in boxes:
        ...
        if class_id == 0 and score > confidence_score:
            box_color = color_red
    ...
    cv2.putText(frame, text_AV, text_loc_AV, font, 2, color_black, thickness=3)

    text_loc_AK = (10, height - 20)
    cv2.putText(frame, text_AK, text_loc_AK, font, 1.5, color_black, thickness=3)
    ...
    cv2.putText(frame, "Actual FPS: " + str(fps), (50, 180), fps_font, 2, color_red, thickness=3)
